...
function dTree(objName, objbool) {        // void ���췽��������������objName: �����ơ�objbool����ѡ��ѡ true��ѡ  false��ѡ  Ĭ�ϵ�ѡ         
    ...
    this.icon = {
        ...
        line:        '/static/dtree/img/line.gif',         // ����,Ĭ��'img/line.gif'
        join:        '/static/dtree/img/join.gif',         // ����,Ĭ��'img/join.gif'
        joinBottom:  '/static/dtree/img/joinbottom.gif',   // ֱ����,Ĭ��'img/joinbottom.gif'
        plus:        '/static/dtree/img/plus.gif',         // �ӺŶ���,Ĭ��'img/plus.gif'
        plusBottom:  '/static/dtree/img/plusbottom.gif',   // �Ӻ�ֱ����,Ĭ��'img/plusbottom.gif'
        minus:       '/static/dtree/img/minus.gif',        // ���Ŷ���,Ĭ��'img/minus.gif'
        minusBottom: '/static/dtree/img/minusbottom.gif',  // ����ֱ����,Ĭ��'img/minusbottom.gif'
        nlPlus:      '/static/dtree/img/nolines_plus.gif', // ����ֱ����,Ĭ��'img/minusbottom.gif'
        nlMinus:     '/static/dtree/img/nolines_minus.gif' //���߼���,Ĭ��'img/nolines_minus.gif'
    };
