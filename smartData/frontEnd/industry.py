...
def main(request):
    if request.method == 'POST':
        ...
        if(action == 'getTradingDatas'):
            ...
            print(datas['tradingCalendar'])
            print(datas['tradingDatas'])
            ...
            datas['allFinancialDatas'] = getFinancialIndicators(industryCode, reportPeriod, indicatorsList)
        ...
        return render(request, "industry.html", {'industryCode':industryCode, 'tradingCalendar': tradingCalendar, 'tradingDatas':tradingDatas})
